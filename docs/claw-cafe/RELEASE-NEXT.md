...
- [x] **CC0** — Tabs Play / Ascension / Host · gates · badge
...
- [x] `cafeTitleStyle` in settings · gamification opt-out
- [x] `qa:cafe-ascension` in qa:local

## Shipped (best-in-class arc — v0.7.0)

- [x] **C4** — Pixel Canvas room + patron avatar + proximity inspect
