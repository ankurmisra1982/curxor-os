...
| Dimension | Pixel Agents / AgentOffice | CurXor Claw Cafe |
|-----------|---------------------------|------------------|
| Job | Monitor coding agents | Mirror **sovereign Claw OS** use |
| Progression | None / hire loop | **G1–G6 ascension** + app epithets |
| Data | JSONL / LLM sim | Local event ledger + real app stores |
| Characters | Dev tools only | **10 OOTB + Forge mints** |
