      ...
      {demoRelease ? (
        <div className="space-y-2">
          ...
          <div className="border border-line/60 bg-panel/50 px-3 py-2 text-[10px] text-muted">
            ...
            <p className="mt-1">
              When ready for live outbound: set <code className="text-cursor-glow">SMTP_HOST</code> and{" "}
              <code className="text-cursor-glow">SMTP_FROM</code> in{" "}
              <code className="text-cursor-glow">digital.env</code>, restart dev, and refresh this checklist.
            </p>
            <p className="mt-1">Guide: docs/outreach-claw/GETTING-STARTED.md</p>
          </div>
        </div>
      ) : null}
