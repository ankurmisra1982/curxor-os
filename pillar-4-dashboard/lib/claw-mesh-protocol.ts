...
export const CCP_REGISTRY: {
  ...
  publications: [
    ...
    },
    {
      appId: "my-capital",
      scopes: ["finance"],
      keys: ["portfolio.*", "rules.*", "risk.*", "intel.*", "forged.*"],
      description: "Portfolio, trading rules, risk guard, market intel",
    },
    {
      appId: "my-work",
      scopes: ["work"],
      keys: ["pipeline.*", "calendar.*", "crm.*", "inbox.*", "forged.*"],
      description: "Outreach and CRM context",
    },
    {
      appId: "tesla-optimus-engine",
      scopes: ["hardware", "signals", "family"],
      keys: ["optimus.*", "humanoid.*", "feeds.*", "triggers.*"],
      description: "Optimus robot state, humanoid knowledge mesh, and signal feeds",
    },
    {
      appId: "my-content-creator",
      scopes: ["work", "personal"],
      keys: ["content.*", "channels.*", "forged.*"],
  ...
  subscriptions: [
    ...
    {
      appId: "my-capital",
      scopes: ["personal", "signals", "finance"],
      profileIds: [],
      description: "Risk profile, signal triggers, and forged capital desks",
    },
    {
      appId: "my-work",
      scopes: ["personal", "family", "work"],
      profileIds: [],
      description: "Outreach tone, household scheduling, and forged work desks",
    },
    {
      appId: "my-content-creator",
      scopes: ["personal", "work", "signals"],
      profileIds: [],
      description: "Content tone, channels, and forged creator desks",
    },
    {
