    ...
    fre: {
      ...
      fields: [
        ...
        },
        {
          ...
          defaultValue: "L1",
          options: [
            { value: "L1", label: "L1 — Visitor (Play default)" },
            { value: "L2", label: "L2 — Regular (Ascension home)" },
            { value: "L3", label: "L3 — Host (kiosk config tab)" },
            { value: "L4", label: "L4 — Patron (Architect inspect)" },
            { value: "L5", label: "L5 — Founder (ops-ready)" },
          ],
        },
      ],
